	<!-- @author: angrodboh -->
	<script src="/bloc/usuarios/js/cabecera.js"></script> <!-- Se incluye el script aqui para evitar copiarlo y pegarlo en todas las páginas -->
	<div id="cabecera">
		<div id="logotipo">
		...
		<ul id="desplegable">
			...
			<li><a href="/bloc/index.jsp?salir">Cerrar Sesión</a></li>
		</ul>
	</div>
